    ...
    private void initComponents() {
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String statusKawinOutput = (status.getSelectedItem() != null) ? status.getSelectedItem().toString(): "";

                String pekerjaanOutput = FormControllers.cekPekerjaan(karyawanSwasta, PNS, wiraswasta, akademisi, pengangguran);
                ...
                Date tglPembuatanKTP = (Date) tanggalPembuatan.getDate();
